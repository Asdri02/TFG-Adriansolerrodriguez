...
El reconocimiento óptico de caracteres se resuelve mediante Tesseract, integrado a través de la biblioteca \texttt{pytesseract}. La elección se debe a varios factores: es una solución consolidada, suficientemente flexible para prototipos avanzados y compatible con un flujo de procesamiento personalizado, y permite trabajar sin entrenar desde cero un modelo específico.
